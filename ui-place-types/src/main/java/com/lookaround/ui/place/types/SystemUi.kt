...
private class SystemUiControllerImpl(private val window: Window) : SystemUiController {
     ...
     * @param darkIcons Whether dark status bar icons would be preferable. Only available on API
     * 23+.
 ...
 * no-op controller; consumers should [provide] [androidx.compose.runtime.CompositionLocalProvider]
 * a real one.
 */
val LocalSysUiController = staticCompositionLocalOf<SystemUiController> { FakeSystemUiController }

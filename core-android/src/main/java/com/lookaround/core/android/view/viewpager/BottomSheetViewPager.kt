...
class BottomSheetViewPager(context: Context, attrs: AttributeSet?) : ViewPager(context, attrs) {
    ...
    private val positionField: Field =
        LayoutParams::class.java.getDeclaredField("position").also { it.isAccessible = true }
        ...
        addOnPageChangeListener(
            object : SimpleOnPageChangeListener() {
                override fun onPageSelected(position: Int) {
                    ...
                    // `BottomSheetBehavior` calls `findScrollingChild()` and recognizes the new
                    // page
    ...
    override fun getChildAt(index: Int): View {
        ...
        val calledFromFindScrollingChild =

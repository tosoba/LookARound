...
public class Math3dUtil {
    ...
    private static final Vector2 viewPortPos = new Vector2();
     ...
     */
    public static void getCamRotation(
     ...
     */
    public static void getRelativeRotation(
            Vector3 inRelativePos,
            Trig3 inCamTrig,
     ...
     * @return drawn
     */
    public static boolean convert3dTo2d(
            Vector3 inRelativePos,

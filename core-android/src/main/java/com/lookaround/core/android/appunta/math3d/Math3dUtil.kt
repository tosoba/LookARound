...
object Math3dUtil {
     ...
     */
    fun getRelativeTranslationInMeters(inPointPos: Vector3, inCamPos: Vector3, outRelativePosInMeters: Vector3) {
        outRelativePosInMeters.z = (inCamPos.z - inPointPos.z) * METERS_IN_A_DEGREE
        outRelativePosInMeters.y = inCamPos.y - inPointPos.y
        outRelativePosInMeters.x = (inCamPos.x - inPointPos.x) * cos(inCamPos.z - inPointPos.z) * METERS_IN_A_DEGREE
    }
